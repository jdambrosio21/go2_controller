...
class Go2Controller:
    ...
    def run_control_loop(self):
        ...
        while True:
            ...
            try:
                ...
                self.update_swing_traj(q, contact_state) #???
    ...
    def run_mpc_update(self, q: np.ndarray, dq: np.ndarray):
    ...
    #                 torque = self.force_mapper.compute_stance_torques(leg, q_joints, dq_joints, force)
    ...
    #                 torque = self.force_mapper.compute_swing_torques(leg, q_joints, dq_joints, 
    #                                          traj.p, 
    #                                          traj.v, 
    #                                          traj.a)
    #                 torques[i*3:(i+1)*3] = torque
